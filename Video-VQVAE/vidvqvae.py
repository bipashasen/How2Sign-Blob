...
class VQVAE(pl.LightningModule):
    ...
    def test_step(self, test_batch, batch_idx):
        ...
        os.makedirs('/ssd_scratch/cvit/bipasha31/outputs/', exist_ok=True)
        save_as = '/ssd_scratch/cvit/bipasha31/outputs/{}'.format(random.randint(0, 100))
        np.savez('{}_original'.format(save_as), data=y.cpu())
        np.savez('{}_reconstructed'.format(save_as), data=x_hat.cpu())
