...
class PixelSNAIL(nn.Module):
    ...
    def forward(self, input, condition=None, cache=None, text_conditioning=None):
        ...
        '''
        Converting B x 16 x 16 to B x 16 x 16 x n_classes
        '''
        input = (
        ...
        if condition is not None and text_conditioning is not 'top':
        ...
        # print(f'condition shape after processing: {condition.shape}')
